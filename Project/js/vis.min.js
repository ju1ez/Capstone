...
! function(t, e) {
	...
	return function(t) {
		...
		e.en = {
			...
			del: "Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ Ð²Ñ‹Ð±Ñ€Ð°Ð½Ð½Ð¾Ðµ",
			back: "ÐÐ°Ð·Ð°Ð´",
			addNode: "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ ÑƒÐ·ÐµÐ»",
			addEdge: "Ð”Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ñ€ÐµÐ±Ñ€Ð¾",
			editNode: "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ ÑƒÐ·ÐµÐ»",
			editEdge: "Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ñ€ÐµÐ±Ñ€Ð¾",
			addDescription: "ÐšÐ»Ð¸ÐºÐ½Ð¸Ñ‚Ðµ Ð² ÑÐ²Ð¾Ð±Ð¾Ð´Ð½Ð¾Ðµ Ð¼ÐµÑÑ‚Ð¾, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ Ð½Ð¾Ð²Ñ‹Ð¹ ÑƒÐ·ÐµÐ».",
			edgeDescription: "ÐšÐ»Ð¸ÐºÐ½Ð¸Ñ‚Ðµ Ð½Ð° ÑƒÐ·ÐµÐ» Ð¸ Ð¿Ñ€Ð¾Ñ‚ÑÐ½Ð¸Ñ‚Ðµ Ñ€ÐµÐ±Ñ€Ð¾ Ðº Ð´Ñ€ÑƒÐ³Ð¾Ð¼Ñƒ ÑƒÐ·Ð»Ñƒ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ ÑÐ¾ÐµÐ´Ð¸Ð½Ð¸Ñ‚ÑŒ Ð¸Ñ….",
			editEdgeDescription: "ÐšÐ»Ð¸ÐºÐ½Ð¸Ñ‚Ðµ Ð½Ð° ÐºÐ¾Ð½Ñ‚Ñ€Ð¾Ð»ÑŒÐ½Ñ‹Ðµ Ñ‚Ð¾Ñ‡ÐºÐ¸ Ð¸ Ð¿ÐµÑ€ÐµÑ‚Ð°Ñ‰Ð¸Ñ‚Ðµ Ð¸Ñ… Ð² ÑƒÐ·ÐµÐ», Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð¿Ð¾Ð´ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒÑÑ Ðº Ð½ÐµÐ¼Ñƒ.",
			createEdgeError: "ÐÐµÐ²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ ÑÐ¾ÐµÐ´Ð¸Ð½Ð¸Ñ‚ÑŒ Ñ€ÐµÐ±Ñ€Ð° Ð² ÐºÐ»Ð°ÑÑ‚ÐµÑ€.",
			deleteClusterError: "ÐšÐ»Ð°ÑÑ‚ÐµÑ€Ñ‹ Ð½Ðµ Ð¼Ð¾Ð³ÑƒÑ‚ Ð±Ñ‹Ñ‚ÑŒ ÑƒÐ´Ð°Ð»ÐµÐ½Ñ‹",
			editClusterError: "ÐšÐ»Ð°ÑÑ‚ÐµÑ€Ñ‹ Ð½ÐµÐ´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ñ‹ Ð´Ð»Ñ Ñ€ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ."
		}, e.ru_RU = e.ru, e.cn = {
			edit: "ç¼–è¾‘",
			del: "åˆ é™¤é€‰å®š",
			back: "è¿”å›ž",
			...
			editNode: "ç¼–è¾‘èŠ‚ç‚¹",
			editEdge: "ç¼–è¾‘è¿žæŽ¥çº¿",
			addDescription: "å•å‡»ç©ºç™½å¤„æ”¾ç½®æ–°èŠ‚ç‚¹ã€‚",
			edgeDescription: "å•å‡»æŸä¸ªèŠ‚ç‚¹å¹¶å°†è¯¥è¿žæŽ¥çº¿æ‹–åŠ¨åˆ°å¦ä¸€ä¸ªèŠ‚ç‚¹ä»¥è¿žæŽ¥å®ƒä»¬ã€‚",
			editEdgeDescription: "å•å‡»æŽ§åˆ¶èŠ‚ç‚¹å¹¶å°†å®ƒä»¬æ‹–åˆ°èŠ‚ç‚¹ä¸Šè¿žæŽ¥ã€‚",
